 ...
 */
class CacheProviderDecoratorFactoryImpl implements CacheProviderDecoratorFactory
{
    /**
     * @var int
     */
    private static $defaultLifetime = CacheProviderDecorator::DEFAULT_LIFE_TIME;
    ...
    public static function create($type, ...$args)
    {
        ...
        return new CacheProviderDecoratorImpl($cacheProvider, self::$defaultLifetime);
    }
